...
class ResidualUNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # Do NOT clamp during training loss.
        # Clamping can kill gradients when values go outside [0, 1].
        # For visualization we clamp later in tensor_to_numpy().
